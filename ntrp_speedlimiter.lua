...
if GetPedInVehicleSeat(TruckId, -1) ==  ped then
...
RegisterCommand("VehCamOff", function() -- Lock Cam
VehCamOff = true
ESX.ShowNotification('~b~Vehicle Cam :~y~ Locked') 
 Citizen.Wait(30)
end)

RegisterCommand("VehCamOn", function() -- Unlock Cam
ESX.ShowNotification('~b~Vehicle Cam :~y~ Unlocked') 
VehCamOff = nil
 Citizen.Wait(30)
end)
